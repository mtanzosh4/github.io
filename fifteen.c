...
bool move(int tile)
{
    ...
    // now switch tile with empty tile if legal move
        ...
        if ((tile_row == blank_row) && ((tile_col + 1) == blank_col) && tile_col < d && tile_row < d)
        {
        ...
        else if ((tile_row == blank_row) && ((tile_col - 1) == blank_col) && tile_col < d && tile_row < d)
        {
            board[tile_row][tile_col - 1] = tile;
            board[tile_row][tile_col] = 0;
            blank_col = tile_col;
        ...
        else if ((tile_col == blank_col) && ((tile_row - 1) == blank_row) && tile_col < d && tile_row < d)
        {
